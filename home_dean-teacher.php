...
<body>
	<div class="nav">
		<ul>
			...
			<li><a href="show_dept.php">Ratings</a></li>
	...
	<div class="row">
			...
			<table id="subj_table">
				...
				<?php
					...
					while($row =mysqli_fetch_assoc($result)){
						...
						$query1 = "SELECT score FROM rating_line_t WHERE subject_line_id=" . $row['subject_line_id'];
						$result1 = mysqli_query($conn,$query1);
						$rating_line_t = mysqli_fetch_array($result1,MYSQLI_ASSOC);
						echo "<tr>";
		...
		<div class="profile_col">
			<center>
				...
				?>
				<p>User-Type: <?php echo $_SESSION['row']['user_type'] ?></p>
